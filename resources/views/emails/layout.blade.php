                            ...
                            <div class="column" style="text-align: center;font-size: 12px;line-height: 19px;color: #adb3b9;font-family: sans-serif;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);">
                                <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 10px;Margin-bottom: 10px;">
                                    <div style="font-size: 12px;line-height: 19px;">
                                        <a target="_blank" style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #adb3b9;margin: 2px;" href="{{ config('app.fb_url') }}"><img style="border: 0;" src="https://i2.createsend1.com/static/eb/master/13-the-blueprint-3/images/facebook.png" width="26" height="26" /></a><a target="_blank" style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #adb3b9;margin: 2px;" href="{{ config('app.tw_url') }}"><img style="border: 0;" src="https://i3.createsend1.com/static/eb/master/13-the-blueprint-3/images/twitter.png" width="26" height="26" /></a><a target="_blank" style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #adb3b9;margin: 2px;" href="{{ config('app.in_url') }}"><img style="border: 0;" src="https://i6.createsend1.com/static/eb/master/13-the-blueprint-3/images/linkedin.png" width="26" height="26" /></a>
                                        <div style="margin: 5px"><a href="{{ config('app.dev_site_url') }}" target="_blank" style="text-decoration: underline;color:#adb3b9;">RS Web Development</a>&nbsp;&#169; 2017</div>
